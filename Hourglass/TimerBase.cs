...
namespace Hourglass
{
    ...
    public abstract class TimerBase : IDisposable, INotifyPropertyChanged
    {
        ...
        public virtual void Start(DateTime start, DateTime end)
        {
            ...
            this.startTime = MathUtility.Min(start, end);
            this.endTime = end;
        ...
        public virtual void Pause()
        {
            ...
            this.timeElapsed = MathUtility.Min(now - (this.startTime ?? now), this.totalTime ?? TimeSpan.Zero);
            this.timeLeft = MathUtility.Max((this.endTime ?? now) - now, TimeSpan.Zero);
            this.startTime = null;
            this.endTime = null;
