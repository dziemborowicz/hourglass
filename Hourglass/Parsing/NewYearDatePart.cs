// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NewYearDatePart.cs" company="Chris Dziemborowicz">
...
namespace Hourglass.Parsing
{
    ...
    /// <summary>
    /// Represents midnight between December 31 and January 1.
    /// </summary>
    /// <seealso cref="SpecialDate.NewYearsEve"/>
    /// <seealso cref="SpecialDatePart"/>
    public class NewYearDatePart : DatePart
    {
        /// <summary>
        ...
        /// <summary>
        /// Parses <see cref="NewYearDatePart"/>s from <see cref="string"/>s.
        /// </summary>
        public new class Parser : DatePart.Parser
        {
            ...
            {
                // This part represents a date and time, so do not allow specifying another time
            ...
            {
                return new[] { @"nye?|new\s*year('?s)?(\s*eve)?" };
            }
